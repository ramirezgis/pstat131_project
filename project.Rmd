...
Now we are going to use cross-validation to fold the training set as a stratified cross-validation with repeats. We are using 10 folds.
...
We see that log_fit has a roc_auc of BLANK. This is pretty high! Let's see for our next model of linear discriminant analysis.
...
We see that lda_fit has a roc_auc of BLANK. Compared to log_reg, this is BLANK.
...
ANALYZE NOW. Now let's see the roc_auc of our best decision tree.
...
We see that we have a roc_auc of 0.88673 of our best performing decision tree on the folds! This is higher than our LDA and linear regression!

Now let's see for nearest neighbors model if it's better than our decision tree.
