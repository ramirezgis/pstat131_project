...
We see that log_fit has a roc_auc of BLANK. This is pretty high! Let's see for our next model of linear discrminant analysis.
...
We see that lda_fit has a roc_auc of BLANK. Compared to log_reg, this is BLANK. Now let's see for our third model called quadratic discriminant analysis.
...
qda_fit <- fit_resamples(qda_wkflow, resamples = booking_folds,
                         control = control)
```
